...
// import "./Styles/appBundle.css";
// import "./Styles/fullCalender.css";
// import "./Styles/jgvMap.css";
// import "./Styles/reactIcons.css";
// import "./Styles/skinMaster.css";
// import "./Styles/vendorsBundle.css";
                            ...
                            <div className="row">
                                                    ...
                                                    <div className="col-lg-7 col-xl-8">
                                                        <div className="position-relative">
                                                            <div className="custom-control custom-switch position-absolute pos-top pos-left ml-5 mt-3 z-index-cloud">
                                                                ...
                                                                <label className="custom-control-label" htmlFor="start_interval">Live Update kjhkjlh</label>
                                                            </div>
                                                            
                                                            <div id="updating-chart" style={{ height: '242px' }} />
                                                        </div>
                                                    </div>
                                                    <div className="col-lg-5 col-xl-4 pl-lg-3">
                                                        ...
                                                        <div className="row no-gutters">
                                                            <div className="col-6 pr-1">
                                                                <a href="#" className="btn btn-default btn-block">Generate PDF</a>
                                                            </div>
                                                            <div className="col-6 pl-1">
                                                                <a href="#" className="btn btn-default btn-block">Report a Bug</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                ...
                                <div className="col-lg-6">
                                    <div id="panel-2" className="panel" data-panel-fullscreen="false">
                                        ...
                                        <div className="panel-container show">
                                            <div className="panel-content p-0">
                                                <div className="d-flex flex-column">
                                                    <div className="bg-subtlelight-fade custom-scroll" style={{ height: '244px' }}>
                                                        <div className="h-100">
                                                            {/* message */}
                                                            <div className="d-flex flex-row px-3 pt-3 pb-2">
                                                                ...
                                                                {/* profile photo end */}
                                                                <div className="ml-3">
                                                                    <a href="javascript:void(0);" title="Lisa Hatchensen" className="d-block fw-700 text-dark">Lisa Hatchensen</a>
                                                                        ...
                                                                        <div className="btn-group mr-1 mt-1" role="group" aria-label="Button group with nested dropdown ">
                                                                            ...
                                                                            <div className="btn-group" role="group">
                                                                                ...
                                                                                <div className="dropdown-menu p-0 fs-xs" aria-labelledby="btnGroupDrop1">
                                                                                    <a className="dropdown-item px-3 py-2" href="#">Forward</a>
                                                                                    <a className="dropdown-item px-3 py-2" href="#">Open</a>
                                                                                    <a className="dropdown-item px-3 py-2" href="#">Delete</a>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        <div className="btn-group mr-1 mt-1" role="group" aria-label="Button group with nested dropdown ">
                                                            ...
                                                            <div className="d-flex flex-row px-3 pt-3 pb-2">
                                                                ...
                                                                {/* profile photo end */}
                                                                <div className="ml-3">
                                                                    <a href="javascript:void(0);" title="Lisa Hatchensen" className="d-block fw-700 text-dark">Dr. Codex Lantern</a>
                                            ...
                                            <div className="panel-content border-faded border-left-0 border-right-0 border-bottom-0 bg-faded">
                                                ...
                                                <div className="d-flex align-items-center py-2 px-2 bg-white border border-top-0 rounded-bottom">
                                                    <div className="btn-group dropup">
                                                        ...
                                                        <div className="dropdown-menu dropdown-menu-animated text-center rounded-pill overflow-hidden" style={{ width: '280px' }}>
                                                            <div className="px-1 py-0">
                                                                <a href="javascript:void(0);" className="emoji emoji--like" data-toggle="tooltip" data-placement="top" title data-original-title="Like">
                                                                    <div className="emoji__hand">
                                                                        <div className="emoji__thumb" />
                                                                    </div>
                                                                </a>
                                                                <a href="javascript:void(0);" className="emoji emoji--love" data-toggle="tooltip" data-placement="top" title data-original-title="Love">
                                                                    <div className="emoji__heart" />
                                                                </a>
                                                                <a href="javascript:void(0);" className="emoji emoji--haha" data-toggle="tooltip" data-placement="top" title data-original-title="Haha">
                                                                ...
                                                                <a href="javascript:void(0);" className="emoji emoji--yay" data-toggle="tooltip" data-placement="top" title data-original-title="Yay">
                                                                    <div className="emoji__face">
                                                                        <div className="emoji__eyebrows" />
                                                                        <div className="emoji__mouth" />
                                                                    </div>
                                                                </a>
                                                                <a href="javascript:void(0);" className="emoji emoji--wow" data-toggle="tooltip" data-placement="top" title data-original-title="Wow">
                                                                    <div className="emoji__face">
                                                                        <div className="emoji__eyebrows" />
                                                                        <div className="emoji__eyes" />
                                                                        <div className="emoji__mouth" />
                                                                ...
                                                                <a href="javascript:void(0);" className="emoji emoji--sad" data-toggle="tooltip" data-placement="top" title data-original-title="Sad">
                                                                    <div className="emoji__face">
                                                                        <div className="emoji__eyebrows" />
                                                                        <div className="emoji__eyes" />
                                                                        <div className="emoji__mouth" />
                                                                ...
                                                                <a href="javascript:void(0);" className="emoji emoji--angry" data-toggle="tooltip" data-placement="top" title data-original-title="Angry">
                                                                    <div className="emoji__face">
                                                                        <div className="emoji__eyebrows" />
                                                                        <div className="emoji__eyes" />
                                                                        <div className="emoji__mouth" />
                                ...
                                <div className="col-lg-6">
                                    <div id="panel-4" className="panel">
                                        ...
                                        <div className="panel-container show">
                                            <div className="panel-content jqvmap-bg-ocean p-0" style={{ height: '330px' }}>
                                                <div id="vector-map" className="w-100 h-100 p-4" />
                                            </div>
                                            <div className="panel-content jqvmap-bg-ocean">
                                                <div className="d-flex align-items-center">
                                                    <img className="d-inline-block js-jqvmap-flag mr-3 border-faded" alt="flag" src="https://lipis.github.io/flag-icon-css/flags/4x3/us.svg" style={{ width: '55px', height: 'auto' }} />
                                    ...
                                    <div id="panel-5" className="panel">
                                        ...
                                        <div className="panel-container show">
                                            <div className="panel-content">
                                                ...
                                                <div id="flotBar1" style={{ width: '100%', height: '160px' }} />
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div className="panel-content">
                                                <div className="row  mb-g">
                                                    <div className="col-md-6 d-flex align-items-center">
                                                        <div id="flotPie" className="w-100" style={{ height: '250px' }} />
                                                    </div>

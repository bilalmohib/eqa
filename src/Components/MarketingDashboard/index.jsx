                            ...
                            <ul id="js-nav-menu" className="nav-menu">
                                ...
                                <li>
                                    <a href="#" title="Font Icons" data-filter-tags="font icons">
                                        ...
                                        <span className="dl-ref bg-primary-500 hidden-nav-function-minify hidden-nav-function-top">7,500+</span>
                                    </a>
                                    <ul>
                                        <li>
                                            ...
                                            <ul>
                                                ...
                                                <li>
                                                    <a href="icons_fontawesome_duotone.html" title="Duotone" data-filter-tags="font icons fontawesome duotone">
                                                        <span className="nav-link-text" data-i18n="nav.font_icons_fontawesome_duotone">Duotone</span>
                                                    </a>
                                                </li>
                                                <li>
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <a href="page_projects.html" title="Projects" data-filter-tags="pages projects">
                                                <span className="nav-link-text" data-i18n="nav.pages_projects">Projects</span>
                                            </a>
                                        </li>
                                        <li>
                    ...
                    <div className="page-content-wrapper">
                                                ...
                                                <div className="custom-scroll h-100">
                                                    <ul className="notification">
                                                        <li className="unread">
                                                            <a href="#" className="d-flex align-items-center">
                                                                <span className="status mr-2">
                                                                    <span className="profile-image rounded-circle d-inline-block" style={{ backgroundImage: 'url("img/demo/avatars/avatar-c.png")' }} />
                                                                </span>
                                                        ...
                                                        <li className="unread">
                                                            <a href="#" className="d-flex align-items-center">
                                                                <span className="status mr-2">
                                                                    <span className="profile-image rounded-circle d-inline-block" style={{ backgroundImage: 'url("img/demo/avatars/avatar-a.png")' }} />
                                                                </span>
                                                                <span className="d-flex flex-column flex-1 ml-1">
                                                        ...
                                                        <li>
                                                            <a href="#" className="d-flex align-items-center">
                                                                <span className="status status-success mr-2">
                                                                    <span className="profile-image rounded-circle d-inline-block" style={{ backgroundImage: 'url("img/demo/avatars/avatar-b.png")' }} />
                                                                </span>
                                                                <span className="d-flex flex-column flex-1 ml-1">
                                                        ...
                                                        <li>
                                                            <a href="#" className="d-flex align-items-center">
                                                                <span className="status status-warning mr-2">
                                                                    <span className="profile-image rounded-circle d-inline-block" style={{ backgroundImage: 'url("img/demo/avatars/avatar-e.png")' }} />
                                                                </span>
                                                                <span className="d-flex flex-column flex-1 ml-1">
                                                        ...
                                                        <li>
                                                            <a href="#" className="d-flex align-items-center">
                                                                <span className="status status-success mr-2">
                                                                    ...
                                                                    <span className="profile-image rounded-circle d-inline-block" style={{ backgroundImage: 'url("img/demo/avatars/avatar-h.png")' }} />
                                                                </span>
                                                                <span className="d-flex flex-column flex-1 ml-1">
                                                        ...
                                                        <li>
                                                            <a href="#" className="d-flex align-items-center">
                                                                <span className="status status-success mr-2">
                                                                    <span className="profile-image rounded-circle d-inline-block" style={{ backgroundImage: 'url("img/demo/avatars/avatar-m.png")' }} />
                                                                </span>
                                                                <span className="d-flex flex-column flex-1 ml-1">
                                                        ...
                                                        <li className="unread">
                                                            <div className="d-flex align-items-center show-child-on-hover">
                                                                ...
                                                                <div className="show-on-hover-parent position-absolute pos-right pos-bottom p-3">
                                                                    <a href="#" className="text-muted" title="delete"><i className="fal fa-trash-alt" /></a>
                                                                </div>
                                                            </div>
                                                        </li>
                                                        <li>
                                                            ...
                                                            <div className="d-flex align-items-center show-child-on-hover">
                                                                ...
                                                                <div className="d-flex flex-column flex-1">
                                                                    ...
                                                                    <div className="fs-sm d-flex align-items-center mt-2">
                                                                        <span className="profile-image-md mr-1 rounded-circle d-inline-block" style={{ backgroundImage: 'url("img/demo/avatars/avatar-a.png")', backgroundSize: 'cover' }} />
                                                                        <span className="profile-image-md mr-1 rounded-circle d-inline-block" style={{ backgroundImage: 'url("img/demo/avatars/avatar-b.png")', backgroundSize: 'cover' }} />
                                                                        <span className="profile-image-md mr-1 rounded-circle d-inline-block" style={{ backgroundImage: 'url("img/demo/avatars/avatar-c.png")', backgroundSize: 'cover' }} />
                                                                        <span className="profile-image-md mr-1 rounded-circle d-inline-block" style={{ backgroundImage: 'url("img/demo/avatars/avatar-e.png")', backgroundSize: 'cover' }} />
                                                                        <div data-hasmore={+3} className="rounded-circle profile-image-md mr-1">
                                                                            <span className="profile-image-md mr-1 rounded-circle d-inline-block" style={{ backgroundImage: 'url("img/demo/avatars/avatar-h.png")', backgroundSize: 'cover' }} />
                                                                        </div>
                                                                    </div>
                                                                ...
                                                                <div className="d-flex flex-column flex-1">
                                                                    ...
                                                                    <div className="fs-sm d-flex align-items-center mt-1">
                                                                        <a href="#" className="mr-1 mt-1" title="Cell A-0012">
                                                                            <span className="d-block img-share" style={{ backgroundImage: 'url("img/thumbs/pic-7.png")', backgroundSize: 'cover' }} />
                                                                        </a>
                                                                        <a href="#" className="mr-1 mt-1" title="Patient A-473 saliva">
                                                                            <span className="d-block img-share" style={{ backgroundImage: 'url("img/thumbs/pic-8.png")', backgroundSize: 'cover' }} />
                                                                        </a>
                                                                        <a href="#" className="mr-1 mt-1" title="Patient A-473 blood cells">
                                                                            <span className="d-block img-share" style={{ backgroundImage: 'url("img/thumbs/pic-11.png")', backgroundSize: 'cover' }} />
                                                                        </a>
                                                                        <a href="#" className="mr-1 mt-1" title="Patient A-473 Membrane O.C">
                                                                            <span className="d-block img-share" style={{ backgroundImage: 'url("img/thumbs/pic-12.png")', backgroundSize: 'cover' }} />
                                                                        </a>
                                                                    </div>
                                                                    <span className="fs-nano text-muted mt-1">55 minutes ago</span>
                                                                </div>
                                                            ...
                                                            <div className="d-flex align-items-center show-child-on-hover">
                                                                ...
                                                                <div className="d-flex flex-column flex-1">
                                                                    ...
                                                                    <div className="progress progress-sm d-flex mt-1">
                                                                        <span className="progress-bar bg-primary-500 progress-bar-striped" role="progressbar" style={{ width: '45%' }} aria-valuenow={45} aria-valuemin={0} aria-valuemax={100} />
                                                                    </div>
                                                        ...
                                                        <table className="table table-bordered table-calendar m-0 w-100 h-100 border-0">
                                                            <tbody><tr>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>4</td>
                                                                    <td>5</td>
                                                                    <td><i className="fal fa-birthday-cake mt-1 ml-1 position-absolute pos-left pos-top text-primary" /> 6</td>
                                                                </tr>
                                                                <tr>
                                                                    <td>7</td>
                                                                    <td>8</td>
                        ...
                        <main id="js-page-content" role="main" className="page-content">
                            <ol className="breadcrumb page-breadcrumb">
                                ...
                                <li className="breadcrumb-item active">Marketing Dashboard</li>
                                <li className="position-absolute pos-top pos-right d-none d-sm-block"><span className="js-get-date" /></li>
                            </ol>
                            <div className="subheader">
                                <h1 className="subheader-title">
                                    <i className="subheader-icon fal fa-chart-area" /> Marketing <span className="fw-300">Dashboard</span>
                                </h1>
                                <div className="subheader-block d-lg-flex align-items-center">
                                    <div className="d-flex mr-4">
                                        <div className="mr-2">
                                            <span className="peity-donut" data-peity="{ &quot;fill&quot;: [&quot;#967bbd&quot;, &quot;#ccbfdf&quot;],  &quot;innerRadius&quot;: 14, &quot;radius&quot;: 20 }">7/10</span>
                                        </div>
                                        <div>
                                            <label className="fs-sm mb-0 mt-2 mt-md-0">New Sessions</label>
                                            <h4 className="font-weight-bold mb-0">70.60%</h4>
                                        </div>
                                    </div>
                                    <div className="d-flex mr-0">
                                        <div className="mr-2">
                                            <span className="peity-donut" data-peity="{ &quot;fill&quot;: [&quot;#2196F3&quot;, &quot;#9acffa&quot;],  &quot;innerRadius&quot;: 14, &quot;radius&quot;: 20 }">3/10</span>
                                        </div>
                                        <div>
                                    ...
                                    <div className="p-3 bg-primary-300 rounded overflow-hidden position-relative text-white mb-g">
                                        <div className>
                                            <h3 className="display-4 d-block l-h-n m-0 fw-500">
                                                21.5k
                                                <small className="m-0 l-h-n">users signed up</small>
                                            </h3>
                                        </div>
                                        <i className="fal fa-user position-absolute pos-right pos-bottom opacity-15 mb-n1 mr-n1" style={{ fontSize: '6rem' }} />
                                    </div>
                                </div>
                                <div className="col-sm-6 col-xl-3">
                                    <div className="p-3 bg-warning-400 rounded overflow-hidden position-relative text-white mb-g">
                                        <div className>
                                            <h3 className="display-4 d-block l-h-n m-0 fw-500">
                                                $10,203
                                                <small className="m-0 l-h-n">Visual Index Figure</small>
                                            </h3>
                                        </div>
                                        <i className="fal fa-gem position-absolute pos-right pos-bottom opacity-15  mb-n1 mr-n4" style={{ fontSize: '6rem' }} />
                                    </div>
                                </div>
                                <div className="col-sm-6 col-xl-3">
                                    <div className="p-3 bg-success-200 rounded overflow-hidden position-relative text-white mb-g">
                                        <div className>
                                            <h3 className="display-4 d-block l-h-n m-0 fw-500">
                                                - 103.72
                                                <small className="m-0 l-h-n">Offset Balance Ratio</small>
                                            </h3>
                                        </div>
                                        <i className="fal fa-lightbulb position-absolute pos-right pos-bottom opacity-15 mb-n5 mr-n6" style={{ fontSize: '8rem' }} />
                                    </div>
                                </div>
                                <div className="col-sm-6 col-xl-3">
                                    <div className="p-3 bg-info-200 rounded overflow-hidden position-relative text-white mb-g">
                                        <div className>
                                            <h3 className="display-4 d-block l-h-n m-0 fw-500">
                                                +40%
                                                <small className="m-0 l-h-n">Product level increase</small>
                                            </h3>
                                        </div>
                                        <i className="fal fa-globe position-absolute pos-right pos-bottom opacity-15 mb-n1 mr-n4" style={{ fontSize: '6rem' }} />
                                    </div>
                                </div>
                            </div>
                            <div className="row">
                                            ...
                                            <div className="panel-content bg-subtlelight-fade">
                                                <div id="js-checkbox-toggles" className="d-flex mb-3">
                                                    <div className="custom-control custom-switch mr-2">
                                                        <input type="checkbox" className="custom-control-input" name="gra-0" id="gra-0" defaultChecked="checked" />
                                                        <label className="custom-control-label" htmlFor="gra-0">Target Profit</label>
                                                    </div>
                                                    <div className="custom-control custom-switch mr-2">
                                                        <input type="checkbox" className="custom-control-input" name="gra-1" id="gra-1" defaultChecked="checked" />
                                                        <label className="custom-control-label" htmlFor="gra-1">Actual Profit</label>
                                                    </div>
                                                    <div className="custom-control custom-switch mr-2">
                                                        <input type="checkbox" className="custom-control-input" name="gra-2" id="gra-2" defaultChecked="checked" />
                                                        <label className="custom-control-label" htmlFor="gra-2">User Signups</label>
                                                    </div>
                                                </div>
                                                <div id="flot-toggles" className="w-100 mt-4" style={{ height: '300px' }} />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div className="col-lg-6">
                                    <div id="panel-2" className="panel panel-locked" data-panel-sortable data-panel-collapsed data-panel-close>
                                        <div className="panel-hdr">
                                            <h2>
                                                Returning <span className="fw-300"><i>Target</i></span>
                                            </h2>
                                        </div>
                                        <div className="panel-container show">
                                            <div className="panel-content poisition-relative">
                                                <div className="p-1 position-absolute pos-right pos-top mt-3 mr-3 z-index-cloud d-flex align-items-center justify-content-center">
                                                    <div className="border-faded border-top-0 border-left-0 border-bottom-0 py-2 pr-4 mr-3 hidden-sm-down">
                                                        <div className="text-right fw-500 l-h-n d-flex flex-column">
                                                            <div className="h3 m-0 d-flex align-items-center justify-content-end">
                                                                <div className="icon-stack mr-2">
                                                                    <i className="base base-7 icon-stack-3x opacity-100 color-success-600" />
                                                                    <i className="base base-7 icon-stack-2x opacity-100 color-success-500" />
                                                                    <i className="fal fa-arrow-up icon-stack-1x opacity-100 color-white" />
                                                                </div>
                                                                $44.34 / GE
                                                            </div>
                                                            <span className="m-0 fs-xs text-muted">Increased Profit as per redux margins and estimates</span>
                                                        </div>
                                                    </div>
                                                    <div className="js-easy-pie-chart color-info-400 position-relative d-inline-flex align-items-center justify-content-center" data-percent={35} data-piesize={95} data-linewidth={10} data-scalelength={5}>
                                                        <div className="js-easy-pie-chart color-success-400 position-relative position-absolute pos-left pos-right pos-top pos-bottom d-flex align-items-center justify-content-center" data-percent={65} data-piesize={60} data-linewidth={5} data-scalelength={1} data-scalecolor="#fff">
                                                            <div className="position-absolute pos-top pos-left pos-right pos-bottom d-flex align-items-center justify-content-center fw-500 fs-xl text-dark">78%</div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div id="flot-area" style={{ width: '100%', height: '300px' }} />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div className="col-lg-6">
                                    <div id="panel-3" className="panel panel-locked" data-panel-sortable data-panel-collapsed data-panel-close>
                                        <div className="panel-hdr">
                                            <h2>
                                                Effective <span className="fw-300"><i>Marketing</i></span>
                                            </h2>
                                        </div>
                                        <div className="panel-container show">
                                            <div className="panel-content poisition-relative">
                                                    ...
                                                    <div className="row">
                                                        <div className="col-6 col-xl-3 d-sm-flex align-items-center">
                                                            <div className="p-2 mr-3 bg-info-200 rounded">
                                                                <span className="peity-bar" data-peity="{&quot;fill&quot;: [&quot;#fff&quot;], &quot;width&quot;: 27, &quot;height&quot;: 27 }">3,4,5,8,2</span>
                                                            </div>
                                                            <div>
                                                                <label className="fs-sm mb-0">Bounce Rate</label>
                                                                <h4 className="font-weight-bold mb-0">37.56%</h4>
                                                            </div>
                                                        </div>
                                                        <div className="col-6 col-xl-3 d-sm-flex align-items-center">
                                                            <div className="p-2 mr-3 bg-info-300 rounded">
                                                                <span className="peity-bar" data-peity="{&quot;fill&quot;: [&quot;#fff&quot;], &quot;width&quot;: 27, &quot;height&quot;: 27 }">5,3,1,7,9</span>
                                                            </div>
                                                            <div>
                                                                <label className="fs-sm mb-0">Sessions</label>
                                                                <h4 className="font-weight-bold mb-0">759</h4>
                                                            </div>
                                                        </div>
                                                        <div className="col-6 col-xl-3 d-sm-flex align-items-center">
                                                            <div className="p-2 mr-3 bg-success-300 rounded">
                                                                <span className="peity-bar" data-peity="{&quot;fill&quot;: [&quot;#fff&quot;], &quot;width&quot;: 27, &quot;height&quot;: 27 }">3,4,3,5,5</span>
                                                            </div>
                                                            <div>
                                                                <label className="fs-sm mb-0">New Sessions</label>
                                                                <h4 className="font-weight-bold mb-0">12.17%</h4>
                                                            </div>
                                                        </div>
                                                        <div className="col-6 col-xl-3 d-sm-flex align-items-center">
                                                            <div className="p-2 mr-3 bg-success-500 rounded">
                                                                <span className="peity-bar" data-peity="{&quot;fill&quot;: [&quot;#fff&quot;], &quot;width&quot;: 27, &quot;height&quot;: 27 }">6,4,7,5,6</span>
                                                            </div>
                                                            <div>
                                                                <label className="fs-sm mb-0">Clickthrough</label>
                                                                <h4 className="font-weight-bold mb-0">19.77%</h4>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div id="flotVisit" style={{ width: '100%', height: '208px' }} />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div className="col-lg-12">
                                    <div id="panel-4" className="panel">
                                        <div className="panel-hdr">
                                            <h2>
                                                Sale <span className="fw-300"><i>Records</i></span>
                                            </h2>
                                        </div>
                                        <div className="panel-container show">
                        ...
                        <footer className="page-footer" role="contentinfo">
                            <div className="d-flex align-items-center flex-1 text-muted">
                                <span className="hidden-md-down fw-700">2020 © SmartAdmin by&nbsp;<a href="https://www.gotbootstrap.com" className="text-primary fw-500" title="gotbootstrap.com" target="_blank">gotbootstrap.com</a></span>
                            </div>
                            <div>
                ...
                <div className="modal-dialog modal-dialog-right">
                    <div className="modal-content h-100">
                        <div className="dropdown-header bg-trans-gradient d-flex align-items-center w-100">
                            <div className="d-flex flex-row align-items-center mt-1 mb-1 color-white">
                                <span className="mr-2">
                                    <span className="rounded-circle profile-image d-block" style={{ backgroundImage: 'url("img/demo/avatars/avatar-d.png")', backgroundSize: 'cover' }} />
                                </span>
                                <div className="info-card-text">
                                    <a href="javascript:void(0);" className="fs-lg text-truncate text-truncate-lg text-white" data-toggle="dropdown" aria-expanded="false">
                                        Tracey Chang
                                        <i className="fal fa-angle-down d-inline-block ml-1 text-white fs-md" />
                                    </a>
                                    <div className="dropdown-menu">
                            ...
                            <div className="msgr-list d-flex flex-column bg-faded border-faded border-top-0 border-right-0 border-bottom-0 position-absolute pos-top pos-bottom">
                                ...
                                <div className="flex-1 h-100 custom-scroll">
                                    <div className="w-100">
                                        <ul id="js-msgr-listfilter" className="list-unstyled m-0">
                                            <li>
                                                <a href="#" className="d-table w-100 px-2 py-2 text-dark hover-white" data-filter-tags="tracey chang online">
                                                    <div className="d-table-cell align-middle status status-success status-sm ">
                                                        <span className="profile-image-md rounded-circle d-block" style={{ backgroundImage: 'url("img/demo/avatars/avatar-d.png")', backgroundSize: 'cover' }} />
                                                    </div>
                                            ...
                                            <li>
                                                <a href="#" className="d-table w-100 px-2 py-2 text-dark hover-white" data-filter-tags="oliver kopyuv online">
                                                    <div className="d-table-cell align-middle status status-success status-sm ">
                                                        <span className="profile-image-md rounded-circle d-block" style={{ backgroundImage: 'url("img/demo/avatars/avatar-b.png")', backgroundSize: 'cover' }} />
                                                    </div>
                                                    <div className="d-table-cell w-100 align-middle pl-2 pr-2">
                                                        <div className="text-truncate text-truncate-md">
                                                            Oliver Kopyuv
                                            ...
                                            <li>
                                                <a href="#" className="d-table w-100 px-2 py-2 text-dark hover-white" data-filter-tags="dr john cook phd away">
                                                    <div className="d-table-cell align-middle status status-warning status-sm ">
                                                        <span className="profile-image-md rounded-circle d-block" style={{ backgroundImage: 'url("img/demo/avatars/avatar-e.png")', backgroundSize: 'cover' }} />
                                                    </div>
                                                    <div className="d-table-cell w-100 align-middle pl-2 pr-2">
                                                        <div className="text-truncate text-truncate-md">
                                                            Dr. John Cook PhD
                                            ...
                                            <li>
                                                <a href="#" className="d-table w-100 px-2 py-2 text-dark hover-white" data-filter-tags="ali amdaney online">
                                                    <div className="d-table-cell align-middle status status-success status-sm ">
                                                        <span className="profile-image-md rounded-circle d-block" style={{ backgroundImage: 'url("img/demo/avatars/avatar-g.png")', backgroundSize: 'cover' }} />
                                                    </div>
                                                    <div className="d-table-cell w-100 align-middle pl-2 pr-2">
                                                        <div className="text-truncate text-truncate-md">
                                                            Ali Amdaney
                                            ...
                                            <li>
                                                <a href="#" className="d-table w-100 px-2 py-2 text-dark hover-white" data-filter-tags="sarah mcbrook online">
                                                    <div className="d-table-cell align-middle status status-success status-sm">
                                                        <span className="profile-image-md rounded-circle d-block" style={{ backgroundImage: 'url("img/demo/avatars/avatar-h.png")', backgroundSize: 'cover' }} />
                                                    </div>
                                                    <div className="d-table-cell w-100 align-middle pl-2 pr-2">
                                                        <div className="text-truncate text-truncate-md">
                                                            Sarah McBrook
                                            ...
                                            <li>
                                                <a href="#" className="d-table w-100 px-2 py-2 text-dark hover-white" data-filter-tags="ali amdaney offline">
                                                    <div className="d-table-cell align-middle status status-sm">
                                                        <span className="profile-image-md rounded-circle d-block" style={{ backgroundImage: 'url("img/demo/avatars/avatar-a.png")', backgroundSize: 'cover' }} />
                                                    </div>
                                                    <div className="d-table-cell w-100 align-middle pl-2 pr-2">
                                                        <div className="text-truncate text-truncate-md">
                                            ...
                                            <li>
                                                <a href="#" className="d-table w-100 px-2 py-2 text-dark hover-white" data-filter-tags="ali amdaney busy">
                                                    <div className="d-table-cell align-middle status status-danger status-sm">
                                                        <span className="profile-image-md rounded-circle d-block" style={{ backgroundImage: 'url("img/demo/avatars/avatar-j.png")', backgroundSize: 'cover' }} />
                                                    </div>
                                                    <div className="d-table-cell w-100 align-middle pl-2 pr-2">
                                                        <div className="text-truncate text-truncate-md">
                                                            oliver.kopyuv@gotbootstrap.com
                                            ...
                                            <li>
                                                <a href="#" className="d-table w-100 px-2 py-2 text-dark hover-white" data-filter-tags="ali amdaney offline">
                                                    <div className="d-table-cell align-middle status status-sm">
                                                        <span className="profile-image-md rounded-circle d-block" style={{ backgroundImage: 'url("img/demo/avatars/avatar-c.png")', backgroundSize: 'cover' }} />
                                                    </div>
                                                    <div className="d-table-cell w-100 align-middle pl-2 pr-2">
                                                        <div className="text-truncate text-truncate-md">
                                                            oliver.kopyuv@gotbootstrap.com
                                            ...
                                            <li>
                                                <a href="#" className="d-table w-100 px-2 py-2 text-dark hover-white" data-filter-tags="ali amdaney inactive">
                                                    <div className="d-table-cell align-middle">
                                                        <span className="profile-image-md rounded-circle d-block" style={{ backgroundImage: 'url("img/demo/avatars/avatar-m.png")', backgroundSize: 'cover' }} />
                                                    </div>
                                                    <div className="d-table-cell w-100 align-middle pl-2 pr-2">
                                                        <div className="text-truncate text-truncate-md">
                                                            +714651347790
                                        ...
                                        <div className="filter-message js-filter-message" />
                                    </div>
                                </div>
                                <div>
                                ...
                                <div className="d-flex flex-column">
                                    <div className="border-faded border-right-0 border-bottom-0 border-left-0 flex-1 mr-3 ml-3 position-relative shadow-top">
                                        <div className="pt-3 pb-1 pr-0 pl-0 rounded-0" tabIndex={-1}>
                                            <div id="msgr_input" contentEditable="true" data-placeholder="Type your message here..." className="height-10 form-content-editable" />
                                        </div>
                                    </div>
                        ...
                        <div className="modal-body p-0">
                            <div className="settings-panel">
                                ...
                                <div className="list" id="fh">
                                    <a href="#" onclick="return false;" className="btn btn-switch" data-action="toggle" data-class="header-function-fixed" />
                                ...
                                <div className="list" id="nff">
                                    <a href="#" onclick="return false;" className="btn btn-switch" data-action="toggle" data-class="nav-function-fixed" />
                                ...
                                <div className="list" id="nfm">
                                    <a href="#" onclick="return false;" className="btn btn-switch" data-action="toggle" data-class="nav-function-minify" />
                                ...
                                <div className="list" id="nfh">
                                    <a href="#" onclick="return false;" className="btn btn-switch" data-action="toggle" data-class="nav-function-hidden" />
                                ...
                                <div className="list" id="nft">
                                    <a href="#" onclick="return false;" className="btn btn-switch" data-action="toggle" data-class="nav-function-top" />
                                ...
                                <div className="list" id="fff">
                                    <a href="#" onclick="return false;" className="btn btn-switch" data-action="toggle" data-class="footer-function-fixed" />
                                ...
                                <div className="list" id="mmb">
                                    <a href="#" onclick="return false;" className="btn btn-switch" data-action="toggle" data-class="mod-main-boxed" />
                                ...
                                <div className="expanded">
                                    <ul className="mb-3 mt-1">
                                        <li>
                                            <div className="bg-fusion-50" data-action="toggle" data-class="mod-bg-1" />
                                        </li>
                                        <li>
                                            <div className="bg-warning-200" data-action="toggle" data-class="mod-bg-2" />
                                        </li>
                                        <li>
                                            <div className="bg-primary-200" data-action="toggle" data-class="mod-bg-3" />
                                        </li>
                                        <li>
                                            <div className="bg-success-300" data-action="toggle" data-class="mod-bg-4" />
                                        </li>
                                        <li>
                                            <div className="bg-white border" data-action="toggle" data-class="mod-bg-none" />
                                        </li>
                                    </ul>
                                    <div className="list" id="mbgf">
                                        <a href="#" onclick="return false;" className="btn btn-switch" data-action="toggle" data-class="mod-fixed-bg" />
                                ...
                                <div className="list" id="nmp">
                                    <a href="#" onclick="return false;" className="btn btn-switch" data-action="toggle" data-class="nav-mobile-push" />
                                ...
                                <div className="list" id="nmno">
                                    <a href="#" onclick="return false;" className="btn btn-switch" data-action="toggle" data-class="nav-mobile-no-overlay" />
                                ...
                                <div className="list" id="sldo">
                                    <a href="#" onclick="return false;" className="btn btn-switch" data-action="toggle" data-class="nav-mobile-slide-out" />
                                ...
                                <div className="list" id="mbf">
                                    <a href="#" onclick="return false;" className="btn btn-switch" data-action="toggle" data-class="mod-bigger-font" />
                                ...
                                <div className="list" id="mhc">
                                    <a href="#" onclick="return false;" className="btn btn-switch" data-action="toggle" data-class="mod-high-contrast" />
                                ...
                                <div className="list" id="mcb">
                                    <a href="#" onclick="return false;" className="btn btn-switch" data-action="toggle" data-class="mod-color-blind" />
                                ...
                                <div className="list" id="mpc">
                                    <a href="#" onclick="return false;" className="btn btn-switch" data-action="toggle" data-class="mod-pace-custom" />
                                ...
                                <div className="list" id="mpi">
                                    <a href="#" onclick="return false;" className="btn btn-switch" data-action="toggle" data-class="mod-panel-icon" />
                                ...
                                <div className="list" id="mcbg">
                                    <a href="#" onclick="return false;" className="btn btn-switch" data-action="toggle" data-class="mod-clean-page-bg" />
                                ...
                                <div className="list" id="mhni">
                                    <a href="#" onclick="return false;" className="btn btn-switch" data-action="toggle" data-class="mod-hide-nav-icons" />
                                ...
                                <div className="list" id="dan">
                                    <a href="#" onclick="return false;" className="btn btn-switch" data-action="toggle" data-class="mod-disable-animation" />
                                ...
                                <div className="list" id="mhic">
                                    <a href="#" onclick="return false;" className="btn btn-switch" data-action="toggle" data-class="mod-hide-info-card" />
                                ...
                                <div className="list" id="mlph">
                                    <a href="#" onclick="return false;" className="btn btn-switch" data-action="toggle" data-class="mod-lean-subheader" />
                                ...
                                <div className="list" id="mnl">
                                    <a href="#" onclick="return false;" className="btn btn-switch" data-action="toggle" data-class="mod-nav-link" />
                                ...
                                <div className="list" id="mdn">
                                    <a href="#" onclick="return false;" className="btn btn-switch" data-action="toggle" data-class="mod-nav-dark" />
                                ...
                                <div className="expanded theme-colors pl-5 pr-3">
                                    <ul className="m-0">
                                        <li>
                                            <a href="#" id="myapp-0" data-action="theme-update" data-themesave data-theme data-toggle="tooltip" data-placement="top" title="Wisteria (base css)" data-original-title="Wisteria (base css)" />
                                        </li>
                                        <li>
                                            <a href="#" id="myapp-1" data-action="theme-update" data-themesave data-theme="css/themes/cust-theme-1.css" data-toggle="tooltip" data-placement="top" title="Tapestry" data-original-title="Tapestry" />
                                        </li>
                                        <li>
                                            <a href="#" id="myapp-2" data-action="theme-update" data-themesave data-theme="css/themes/cust-theme-2.css" data-toggle="tooltip" data-placement="top" title="Atlantis" data-original-title="Atlantis" />
                                        </li>
                                        <li>
                                            <a href="#" id="myapp-3" data-action="theme-update" data-themesave data-theme="css/themes/cust-theme-3.css" data-toggle="tooltip" data-placement="top" title="Indigo" data-original-title="Indigo" />
                                        </li>
                                        <li>
                                            <a href="#" id="myapp-4" data-action="theme-update" data-themesave data-theme="css/themes/cust-theme-4.css" data-toggle="tooltip" data-placement="top" title="Dodger Blue" data-original-title="Dodger Blue" />
                                        </li>
                                        <li>
                                            <a href="#" id="myapp-5" data-action="theme-update" data-themesave data-theme="css/themes/cust-theme-5.css" data-toggle="tooltip" data-placement="top" title="Tradewind" data-original-title="Tradewind" />
                                        </li>
                                        <li>
                                            <a href="#" id="myapp-6" data-action="theme-update" data-themesave data-theme="css/themes/cust-theme-6.css" data-toggle="tooltip" data-placement="top" title="Cranberry" data-original-title="Cranberry" />
                                        </li>
                                        <li>
                                            <a href="#" id="myapp-7" data-action="theme-update" data-themesave data-theme="css/themes/cust-theme-7.css" data-toggle="tooltip" data-placement="top" title="Oslo Gray" data-original-title="Oslo Gray" />
                                        </li>
                                        <li>
                                            <a href="#" id="myapp-8" data-action="theme-update" data-themesave data-theme="css/themes/cust-theme-8.css" data-toggle="tooltip" data-placement="top" title="Chetwode Blue" data-original-title="Chetwode Blue" />
                                        </li>
                                        <li>
                                            <a href="#" id="myapp-9" data-action="theme-update" data-themesave data-theme="css/themes/cust-theme-9.css" data-toggle="tooltip" data-placement="top" title="Apricot" data-original-title="Apricot" />
                                        </li>
                                        <li>
                                            <a href="#" id="myapp-10" data-action="theme-update" data-themesave data-theme="css/themes/cust-theme-10.css" data-toggle="tooltip" data-placement="top" title="Blue Smoke" data-original-title="Blue Smoke" />
                                        </li>
                                        <li>
                                            <a href="#" id="myapp-11" data-action="theme-update" data-themesave data-theme="css/themes/cust-theme-11.css" data-toggle="tooltip" data-placement="top" title="Green Smoke" data-original-title="Green Smoke" />
                                        </li>
                                        <li>
                                            <a href="#" id="myapp-12" data-action="theme-update" data-themesave data-theme="css/themes/cust-theme-12.css" data-toggle="tooltip" data-placement="top" title="Wild Blue Yonder" data-original-title="Wild Blue Yonder" />
                                        </li>
                                        <li>
                                            <a href="#" id="myapp-13" data-action="theme-update" data-themesave data-theme="css/themes/cust-theme-13.css" data-toggle="tooltip" data-placement="top" title="Emerald" data-original-title="Emerald" />
                                        </li>
                                        <li>
                                            <a href="#" id="myapp-14" data-action="theme-update" data-themesave data-theme="css/themes/cust-theme-14.css" data-toggle="tooltip" data-placement="top" title="Supernova" data-original-title="Supernova" />
                                        </li>
                                        <li>
                                            <a href="#" id="myapp-15" data-action="theme-update" data-themesave data-theme="css/themes/cust-theme-15.css" data-toggle="tooltip" data-placement="top" title="Hoki" data-original-title="Hoki" />
                                        </li>
                                    </ul>
                                </div>
                                <hr className="mb-0 mt-4" />
                                            ...
                                            <div id="skin-default" data-action="toggle-replace" data-replaceclass="mod-skin-light mod-skin-dark" data-class data-toggle="tooltip" data-placement="top" title className="d-flex bg-white border border-primary rounded overflow-hidden text-success js-waves-on" data-original-title="Default Mode" style={{ height: '80px' }}>
                                                ...
                                                <div className="d-flex flex-column flex-1">
                                                    ...
                                                    <div className="bg-faded flex-1 pt-3 pb-3 px-2">
                                                        <div className="py-3" style={{ background: 'url("img/demo/s-1.png") top left no-repeat', backgroundSize: '100%' }} />
                                                    </div>
                                                </div>
                                            </div>
                                            Default
                                            ...
                                            <div id="skin-dark" data-action="toggle-replace" data-replaceclass="mod-skin-light" data-class="mod-skin-dark" data-toggle="tooltip" data-placement="top" title className="d-flex bg-white border border-dark rounded overflow-hidden text-success js-waves-on" data-original-title="Dark Mode" style={{ height: '80px' }}>
                                                ...
                                                <div className="d-flex flex-column flex-1">
                                                    ...
                                                    <div className="bg-fusion-300 flex-1 pt-3 pb-3 px-2">
                                                        <div className="py-3 opacity-30" style={{ background: 'url("img/demo/s-1.png") top left no-repeat', backgroundSize: '100%' }} />
                                                    </div>
                                                </div>
                                            </div>
                                            Dark
